...
Run `claude-remote status $ARGUMENTS` and present the output. If `$ARGUMENTS` is empty, fall back to `claude-remote list` and offer the user a project to drill into.
